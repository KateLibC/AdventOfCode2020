    ...
    for y in data:
        for z in data:
            if x+y+z == 2020:
                print(f'{x} + {y} + {z} = {x+y+z}')
                print(f'{x} * {y} * {z} = {x*y*z}')
print(f'Completed in: {time() - ts}\n')

# Better
ts = time()
print('Better-ish coding:')
i = {}
e = True
for x in data:
    for y in data:
